...
$sql = "SELECT TABLE_NAME FROM INFORMATION_SCHEMA.TABLES WHERE table_schema='aidjob_0617' ORDER BY TABLE_NAME";
$result = mysqli_query($link, $sql) or die("無法送出" . mysqli_error());

$tables = array();

$i = 0;
while ($row = $result->fetch_assoc()) { //輸出所有包含關鍵字的職缺名稱
